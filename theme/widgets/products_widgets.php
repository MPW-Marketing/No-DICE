...
function btp_init_recent_products_widget() {
	register_widget( 'BTP_Recent_Products_Widget' );
}

class BTP_Recent_Products_Widget extends WP_Widget {
	
	function BTP_Recent_Products_Widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_btp_recent_products', 'description' => __('The most recent products on your site', 'btp_theme') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'btp_recent_products_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'btp_recent_products_widget', __('BTP Recent Products', 'btp_theme'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		$btp_shortcode = '[recent_products ';
			...
			$hide .= $instance['hide_price'] ? 'price,' : '';
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['hide_price'] 		= btp_bool($new_instance['hide_price']);
	...
	function form( $instance ) {
		...
		$templates = btp_get_product_collection_templates();

		/* Set up some default widget settings. */
		$defaults = array( 
			'title' 				=> __('Recent products', 'btp_theme'),
			'cat'					=> '',
			'max'					=> 1,
			'max_per_row'			=> 0,
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'cat' ); ?>"><?php _e('Product category slug', 'btp_theme'); ?>:</label>
		...
		<p>
			...
			<br />
			<input class="checkbox" type="checkbox" id="<?php echo $this->get_field_id( 'hide_price' ); ?>" name="<?php echo $this->get_field_name( 'hide_price' ); ?>" value="true" <?php if($instance['hide_price']) echo 'checked="checked"'; ?>/>
			<label for="<?php echo $this->get_field_id( 'hide_price' ); ?>"><?php _e('Hide price?', 'btp_theme'); ?></label>
			<br />
...
/* Function called by action/hook 'widgets_init' */
function btp_init_custom_products_widget() {
	register_widget( 'BTP_Custom_Products_Widget' );
}

class BTP_Custom_Products_Widget extends WP_Widget {
	
	function BTP_Custom_Products_Widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_btp_custom_products', 'description' => __('Custom products based on ids', 'btp_theme') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'btp_custom_products_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'btp_custom_products_widget', __('BTP Custom Products', 'btp_theme'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		/* Set up some default widget settings. */
		$defaults = array( 
			'title' 			=> __('Featured products', 'btp_theme'),
			'ids'				=> '',
			'max_per_row'		=> 0,
			'template'			=> key($templates),			
			'hide_title'		=> false,
...
/* Function called by action/hook 'widgets_init' */
function btp_init_popular_products_widget() {
	register_widget( 'BTP_Popular_Products_Widget' );
}

class BTP_Popular_Products_Widget extends WP_Widget {
	
	function BTP_Popular_Products_Widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_btp_popular_products', 'description' => __('The most popular products on your site based on comment count', 'btp_theme') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'btp_popular_products_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'btp_popular_products_widget', __('BTP Popular Products', 'btp_theme'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		$btp_shortcode = '[popular_products ';
			$btp_shortcode .= 'max="'.$instance['max'].'" ';
			$btp_shortcode .= 'max_per_row="'.$instance['max_per_row'].'" ';
			$btp_shortcode .= 'template="'.$instance['template'].'" ';
	...
	function form( $instance ) {
		...
		/* Set up some default widget settings. */
		$defaults = array( 
			'title' 				=> __('Popular products', 'btp_theme'),
			'max'					=> 1,
			'max_per_row'			=> 0,
			'template'				=> key($templates),			
			'hide_title'			=> false,
...
/* Function called by action/hook 'widgets_init' */
function btp_init_related_products_widget() {
	register_widget( 'BTP_Related_Products_Widget' );
}

class BTP_Related_Products_Widget extends WP_Widget {
	
	function BTP_Related_Products_Widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_btp_related_products', 'description' => __('Related products based on relation tags', 'btp_theme') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'btp_related_products_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'btp_related_products_widget', __('BTP Related Products', 'btp_theme'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		$btp_shortcode = '[related_products ';
	...
	function form( $instance ) {
		...
		/* Set up some default widget settings. */
		$defaults = array( 
			'title' 			=> __('Related products', 'btp_theme'),
			'id'				=> '',
			'max'				=> 1,
			'max_per_row'		=> 0,
			'template'			=> key($templates),			
