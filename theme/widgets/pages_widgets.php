...
function btp_init_custom_pages_widget() {
...
class BTP_Custom_Pages_Widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		$templates = btp_get_page_collection_templates();
...
/* Function called by action/hook 'widgets_init' */
function btp_init_related_pages_widget() {
